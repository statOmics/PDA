...
You can verify that your installation was successful by running our
[installation check script](https://raw.githubusercontent.com/statOmics/PDA/main/R/check_installation.R)
in R:

```{r, eval = FALSE}
source("https://raw.githubusercontent.com/statOmics/PDA/main/R/check_installation.R")
```

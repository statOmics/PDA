...
### Detailed Program
  ...
  1. Introduction to experimental design: [Experimental Design](./pda_experimentalDesign1.html)
...
- Pedro Fernandes, Coordinator of the GTPB Bioinformatics Training Programme, Instituto Gulbenkian de Ciencia, who radically changed our view on teaching and immersed us in the teaching method that we use in this course.


- Léopold Guyot, Loïc Guille and the Laurent Gatto lab for the development of [QFeaturesGUI](https://github.com/UCLouvain-CBIO/QFeaturesGUI), which we temporarily forked because we needed some additional functionalities for this course. 

...
across samples. Therefore we will normalise the data using the Median of Ratios 
method of DESeq2, which can correct for differences in overall loading across 
runs as well as for differences in sample composition. 

...
<img src="./figs/placebo.png" width="20%" style="float: right;">
...
![](./figs/mouseCage.png){width=25%}

- Mouse study (30 mice)

![](./figs/mouseCage.png){width=25%}![](./figs/mouseCage.png){width=25%}![](./figs/mouseCage.png){width=25%}    

- Mouse study (10 mice)

![](./figs/mouseCageBlocking.png){width=25%}
...
knitr::include_graphics("./figs/blockingMouseTmds.png")
```

# Implications of different technologies

<img src="./figs/labelVsLabelFree.png" width="100%">
